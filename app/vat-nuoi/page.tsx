...
function VatNuoiInner() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#faf8f4' }}>
      ...
      {/* Header */}
      <header className="border-b border-stone-200" style={{ backgroundColor: '#78350f' }}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-5 lg:py-6">
          <div className="flex items-end justify-between gap-3 mb-4">
            <div>
              <nav className="text-[11px] text-amber-200/80 mb-1 flex items-center gap-1">
                <Link href="/" className="hover:text-white">Trang chủ</Link>
                <i className="ri-arrow-right-s-line"></i>
                <span className="text-amber-200">Vật nuôi</span>
              </nav>
              <h1 className="text-xl sm:text-2xl font-bold text-white leading-tight">
                {search ? `Kết quả "${search}"` : 'Mua bán vật nuôi tại Nhân Cơ'}
              </h1>
              <p className="text-[12px] text-amber-200/90 mt-0.5">
