...
const categories = [
  ...
  { title: 'Vật nuôi', href: '/vat-nuoi', img: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=120&h=120&fit=crop&q=80' },
  { title: 'Dịch vụ', href: '/dich-vu', img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=120&h=120&fit=crop&q=80' },
