        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col items-center text-center gap-4 max-w-2xl mx-auto">
            <div>
              ...
              <h1 className="text-2xl font-semibold text-ink">Quảng cáo &amp; Thông báo</h1>
              <p className="text-ink-soft text-sm mt-1">{total} tin quảng cáo từ cửa hàng địa phương</p>
            </div>
            <div className="flex gap-2 w-full">
              <form onSubmit={e => { e.preventDefault(); loadData(1); }} className="flex flex-1 gap-2">
                <input type="text" placeholder="Tìm cửa hàng, sự kiện..." value={search}
                  ...
                  className="flex-1 px-4 py-2 rounded-xl text-sm bg-white border border-line text-ink placeholder-ink-faint focus:outline-none focus:border-brand-300" />
                <button type="submit" className="bg-ink text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-black">Tìm</button>
              </form>
              <Link href="/advertisements/create" className="bg-brand-500 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-brand-600 whitespace-nowrap">
                + Đăng quảng cáo
              </Link>
            </div>
          </div>
