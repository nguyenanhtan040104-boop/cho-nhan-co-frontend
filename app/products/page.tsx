  ...
  return (
    <div className="mt-8 space-y-5">
      ...
      <section className="bg-white border border-stone-200 rounded-lg p-5 flex items-center gap-4 flex-wrap">
        ...
        <Link href="/products/create"
          className="bg-forest-700 hover:bg-forest-800 text-white text-[13px] font-semibold px-4 py-2 rounded transition-colors">
          + Đăng tin ngay
        </Link>
      </section>
      ...
      >
        <div className="relative bg-stone-100 overflow-hidden" style={{ aspectRatio: '4/3' }}>
          ...
          {product.isVip ? (
            ...
            <span className="absolute top-2 left-2 bg-white/95 text-forest-700 text-[10px] font-bold px-1.5 py-0.5 rounded border border-forest-200">
              MỚI
            </span>
          )}
        </div>
        ...
        <div className="p-3">
          <h4 className="text-[13.5px] font-medium text-gray-900 line-clamp-2 leading-snug min-h-[2.5em] mb-1.5 group-hover:text-forest-800 transition-colors">
            {product.title}
          </h4>
          ...
          <div className="flex items-center gap-2 text-[11px] text-gray-500 mb-2">
            ...
            {typeof product._distanceKm === 'number' && (
              <span className="flex items-center gap-0.5 text-forest-700 font-semibold flex-shrink-0" title="Khoảng cách từ vị trí của bạn">
                <i className="ri-navigation-fill text-forest-600"></i>{formatDistance(product._distanceKm)}
              </span>
            )}
      ...
      >
        <div className="relative w-32 sm:w-40 flex-shrink-0 bg-stone-100" style={{ aspectRatio: '4/3' }}>
          ...
          {product.isVip ? (
            ...
            <span className="absolute top-1.5 left-1.5 bg-white/95 text-forest-700 text-[10px] font-bold px-1.5 py-0.5 rounded border border-forest-200">MỚI</span>
          )}
        </div>
        <div className="flex-1 min-w-0 py-2.5 pr-10">
          <h4 className="text-[14px] font-medium text-gray-900 line-clamp-2 leading-snug group-hover:text-forest-800 transition-colors">
            {product.title}
          </h4>
